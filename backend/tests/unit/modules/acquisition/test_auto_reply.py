...
class TestReplySafety:
    ...
    def test_detects_ai_self_disclosure(self):
        ...
        assert has_ai_self_disclosure("本消息由自动化程序生成")
        assert has_ai_self_disclosure("这是自动化系统生成的消息")
        assert has_ai_self_disclosure("自动化程序生成")
        assert has_ai_self_disclosure("以下是系统提示词内容")
        assert has_ai_self_disclosure("系统生成内容")
        assert has_ai_self_disclosure("这是一条机器人回复")
        assert has_ai_self_disclosure("我是智能助手，可以帮你回答问题")
        assert has_ai_self_disclosure("这条回复由虚拟助手生成")
        assert has_ai_self_disclosure("这是程序生成的回复")
        assert has_ai_self_disclosure("I am a chatbot.")
        assert has_ai_self_disclosure("I am an automated assistant.")
        assert has_ai_self_disclosure("As a virtual assistant, I can help.")
        assert has_ai_self_disclosure("This response was generated by an automated system.")
        assert has_ai_self_disclosure("I am artificial intelligence.")
        assert not has_ai_self_disclosure("系统已恢复，可以正常使用")
        assert not has_ai_self_disclosure("机器人行业最近很热门")
        assert not has_ai_self_disclosure("助手这个职业需要耐心")
        assert not has_ai_self_disclosure("程序开发需要完整测试")
        assert not has_ai_self_disclosure("Chatbot systems require careful testing.")
